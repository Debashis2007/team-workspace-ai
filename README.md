...
**Parent system design:** [10 — Global Realtime Product Surface](https://github.com/Debashis2007/team-workspace-ai/blob/main/10-global-realtime-product-surface.md)  
**Also references:** [04 — RAG](https://github.com/Debashis2007/team-workspace-ai/blob/main/04-rag-embedding-pipeline.md), [07 — Agents](https://github.com/Debashis2007/team-workspace-ai/blob/main/07-agent-runtime-containment.md)
...
| Knowledge | Shared corpus with ACL ([04](https://github.com/Debashis2007/team-workspace-ai/blob/main/04-rag-embedding-pipeline.md)) |
...
Workspace → SSO/roles → shared threads
  → generation with workspace policy packs ([06](https://github.com/Debashis2007/team-workspace-ai/blob/main/06-safety-moderation-pipeline.md))
  → optional connectors via contained agents ([07](https://github.com/Debashis2007/team-workspace-ai/blob/main/07-agent-runtime-containment.md))
